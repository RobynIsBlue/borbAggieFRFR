...
SELECT id, created_at, updated_at, name, url, user_id, last_fetched_at FROM feeds WHERE $1 = id
`
...
SELECT id, created_at, updated_at, name, url, user_id, last_fetched_at FROM feeds WHERE $1 = url
`
